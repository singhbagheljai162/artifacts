      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <ul class="nav">
            <li class="nav-item nav-profile">
              <a href="#" class="nav-link">
                <div class="nav-profile-image">
                  <img src="<?php echo BASE_URL;?>/dist/assets/images/faces/face1.jpg" alt="profile" />
            ...
            <li class="nav-item">
              <a class="nav-link" href="<?php echo BASE_URL;?>/dist/index.html">
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="ui-basic">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item">
                    <a class="nav-link" href="<?php echo BASE_URL;?>/dist/pages/ui-features/buttons.html">Buttons</a>
                  </li>
                  <li class="nav-item">
